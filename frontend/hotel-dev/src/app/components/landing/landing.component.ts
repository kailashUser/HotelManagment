  ...
  reviews = [
    {
      ...
      name: 'John Smith',
      rating: 5,
      comment: 'Amazing experience! The staff was incredibly attentive and the facilities were top-notch.',
    ...
    },
    {
      ...
      name: 'Sarah Johnson',
      rating: 5,
      comment: 'The presidential suite was absolutely breathtaking. Worth every penny!',
