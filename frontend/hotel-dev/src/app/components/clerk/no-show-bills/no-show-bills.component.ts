...
import { NoShowServiceService } from './no-show.service.service';

@Component({
  selector: 'app-no-show-bills',
  imports: [CommonModule],
  templateUrl: './no-show-bills.component.html',
  styleUrl: './no-show-bills.component.css',
})
export class NoShowBillsComponent {
  ...
  constructor(private noShowService: NoShowServiceService) {}
  ngOnInit(): void {
    this.noShowService.getBillingReport().subscribe({
      next: (data) => {
